...
import org.netbeans.modules.web.primefaces.crudgenerator.api.editor.JSFBeanCache;
...
public class ManagedBeanCustomizer extends javax.swing.JPanel implements CancellableDialog {
    ...
    public static final String VIEW_TEMPLATE = "/Templates/MyCRUDGen/JSF_From_Entity_Snippets/view.ftl"; // NOI18N
    public static final String EDIT_TEMPLATE = "/Templates/MyCRUDGen/JSF_From_Entity_Snippets/edit.ftl"; // NOI18N
    public static final String TABLE_TEMPLATE = "/Templates/MyCRUDGen/JSF_From_Entity_Snippets/table.ftl"; // NOI18N
    ...
    private void initComponents() {
        ...
        entityBeanLabel.setText(org.openide.util.NbBundle.getMessage(ManagedBeanCustomizer.class, "ManagedBeanCustomizer.entityBeanLabel.text_1")); // NOI18N
        ...
        managedBeanLabel.setText(org.openide.util.NbBundle.getMessage(ManagedBeanCustomizer.class, "ManagedBeanCustomizer.managedBeanLabel.text_1")); // NOI18N
        ...
        readOnlyCheckBox.setText(org.openide.util.NbBundle.getMessage(ManagedBeanCustomizer.class, "ManagedBeanCustomizer.readOnlyCheckBox.text_1")); // NOI18N

        customizeTemplatesLabel.setText(org.openide.util.NbBundle.getMessage(ManagedBeanCustomizer.class, "ManagedBeanCustomizer.customizeTemplatesLabel.text_1")); // NOI18N
        ...
        hint.setText(org.openide.util.NbBundle.getMessage(ManagedBeanCustomizer.class, "ManagedBeanCustomizer.hint.text_1")); // NOI18N

        scanningLabel.setFont(new java.awt.Font("Dialog", 2, 12)); // NOI18N
        scanningLabel.setForeground(new java.awt.Color(153, 153, 153));
        scanningLabel.setText(org.openide.util.NbBundle.getMessage(ManagedBeanCustomizer.class, "ManagedBeanCustomizer.scanningLabel.text_1")); // NOI18N
