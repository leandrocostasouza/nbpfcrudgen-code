...
import org.netbeans.modules.web.primefaces.crudgenerator.palette.items.JsfForm;
import org.netbeans.modules.web.primefaces.crudgenerator.palette.items.JsfTable;
        ...
        controllerJavaSource.runModificationTask(new Task<WorkingCopy>() {
            public void run(WorkingCopy workingCopy) throws IOException {
                ...
                if (useSessionBean) {
                    ...
                    String parameters = isInjection ? "utx, emf" : "javax.persistence.Persistence.createEntityManagerFactory(\"" + persistenceUnit + "\")";
