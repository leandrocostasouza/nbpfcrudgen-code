...
public class TemplateIterator implements TemplateWizard.Iterator {
    ...
    //2013-01-08 Kay Wrobel: make this the new default method. It passes null down for template file name
    //in order to provide old functionality
    static FileObject createTemplate(Project project, FileObject targetDir, boolean addJSFFrameworkIfNecessary) throws IOException {
        return createTemplate(null, project, targetDir, addJSFFrameworkIfNecessary);
    }

    //2013-01-08 Kay Wrobel: allow passing in of a template file name
    static FileObject createTemplate(String templateFile, Project project, FileObject targetDir, boolean addJSFFrameworkIfNecessary) throws IOException {
        ...
        if (wm != null) {
            ...
            //2013-01-08 Kay Wrobel: Only grab template file if nothing was specified
            if (templateFile == null) {
                boolean isJSF20 = JSFUtils.isJSF20Plus(wm);
                templateFile = TEMPLATE_XHTML;
                if (isJSF20) {
            ...
            if (wm != null) {
                ...
                df.getPrimaryFile().getFileSystem().runAtomicAction(new FileSystem.AtomicAction() {
                    public void run() throws IOException {
                        ...
                        if (cssFolder == null) //                            cssFolder = docBase.createFolder(folderName);
                        {
