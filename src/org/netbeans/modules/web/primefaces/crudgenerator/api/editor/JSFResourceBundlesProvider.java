...
package org.netbeans.modules.web.primefaces.crudgenerator.api.editor;
            ...
            return model.runReadAction(new MetadataModelAction<JsfModel, List<ResourceBundle>>() {
                ...
                public List<ResourceBundle> run(JsfModel metadata) throws Exception {
                    ...
                    for (Application application : applications) {
                        for (org.netbeans.modules.web.primefaces.crudgenerator.api.facesmodel.ResourceBundle bundle : application.getResourceBundles()) {
