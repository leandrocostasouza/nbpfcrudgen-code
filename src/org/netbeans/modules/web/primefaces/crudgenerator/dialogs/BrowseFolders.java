...
public class BrowseFolders extends javax.swing.JPanel implements ExplorerManager.Provider {
    ...
    public BrowseFolders( SourceGroup[] folders) {
        ...
        btv.getAccessibleContext().setAccessibleName(java.util.ResourceBundle.getBundle("org/netbeans/modules/web/primefaces/crudgenerator/dialogs/Bundle").getString("ACSN_FlodersTree"));
        btv.getAccessibleContext().setAccessibleDescription(java.util.ResourceBundle.getBundle("org/netbeans/modules/web/primefaces/crudgenerator/dialogs/Bundle").getString("ACSD_FlodersTree"));
    ...
    public static FileObject showDialog( SourceGroup[] folders ) {
        ...
        options[ 0 ].getAccessibleContext().setAccessibleDescription(java.util.ResourceBundle.getBundle("org/netbeans/modules/web/primefaces/crudgenerator/dialogs/Bundle").getString("ACSD_SelectFile"));
        options[ 1 ].setActionCommand( OptionsListener.COMMAND_CANCEL );
        options[ 1 ].addActionListener( optionsListener );    
        options[ 1 ].getAccessibleContext().setAccessibleDescription(java.util.ResourceBundle.getBundle("org/netbeans/modules/web/primefaces/crudgenerator/dialogs/Bundle").getString("ACSD_Cancel"));
