...
package org.netbeans.modules.web.primefaces.crudgenerator.dialogs;
...
public class AddDialog extends DialogDescriptor {
    ...
    static {
        ADD_OPTION.getAccessibleContext().setAccessibleDescription(java.util.ResourceBundle.getBundle("org/netbeans/modules/web/primefaces/crudgenerator/dialogs/Bundle").getString("ACSD_Add"));
    }
